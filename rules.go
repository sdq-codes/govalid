...
var rulesFuncMap = make(map[string]func(string, string, string, interface{}, *Validator) error)
...
// fn func(name string, fn func(field string, rule string, message string, value interface{}, allFields *Validator ) error
// see example in readme: https://github.com/thedevsaddam/govalidator#add-custom-rules
func AddCustomRule(name string, fn func(field string, rule string, message string, value interface{}, allFields *Validator) error) {
	if isRuleExist(name) {
...
func validateCustomRules(field string, rule string, message string, value interface{}, errsBag url.Values, allFields *Validator) {
	for k, v := range rulesFuncMap {
		if k == rule || strings.HasPrefix(rule, k+":") {
			err := v(field, rule, message, value, allFields)
			if err != nil {
...
func init() {
	...
	AddCustomRule("required", func(field, rule, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("regex", func(field, rule, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("alpha", func(field string, vlaue string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("alpha_dash", func(field string, vlaue string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	// AlphaDash check if provided field contains valid letters, numbers, underscore and dash
	AddCustomRule("alpha_space", func(field string, vlaue string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("alpha_num", func(field string, vlaue string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("bool", func(field string, vlaue string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("between", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("credit_card", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("coordinate", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	// Coordinate check if provided field contains valid Coordinate
	AddCustomRule("confirm", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("css_color", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("digits", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("digits_between", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("date", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("email", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("float", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("ip", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("ip_v4", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("ip_v6", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("json", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("lat", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("lon", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("len", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("min", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("max", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("mac_address", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	// Numeric check if the value of the field is Numeric
	AddCustomRule("numeric", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("numeric_between", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	AddCustomRule("url", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
		err := fmt.Errorf("The %s field format is invalid", field)
		if message != "" {
			err = errors.New(message)
	...
	AddCustomRule("uuid", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("uuid_v3", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("uuid_v4", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("uuid_v5", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
		str := toString(value)
	...
	AddCustomRule("in", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
	...
	// In check if provided field equals one of the values specified in the rule
	AddCustomRule("not_in", func(field string, rule string, message string, value interface{}, allFields *Validator) error {
